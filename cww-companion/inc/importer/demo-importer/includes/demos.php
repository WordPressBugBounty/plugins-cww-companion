	...
	class CWW_Demos {
		...
		public function ajax_demo_data() {
			...
			<div id="cww-demo-plugins">
				...
				<?php }else{?>
					<a class="cww-button purchase-btn" href="<?php echo esc_url($purchase_link); ?>" target="_blank" style="background-color: #4CAF50"><?php esc_html_e( 'Purchase Now', 'cww-companion' ); ?></a>
				<?php }?>
